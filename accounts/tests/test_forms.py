...
class CustomUserCreationFormTests(TestCase):
    ...
    def test_custom_user_creation_form_field_labels(self):
        ...
        self.assertTrue(form.fields['username'].label == 'Username' or form.fields['username'].label == None)
        self.assertTrue(form.fields['first_name'].label == 'First name' or form.fields['first_name'].label == None)
        self.assertTrue(form.fields['last_name'].label == 'Last name' or form.fields['last_name'].label == None)
        self.assertTrue(form.fields['position'].label == 'Position' or form.fields['position'].label == None)
        self.assertTrue(form.fields['email'].label == 'Email' or form.fields['email'].label == None)
    ...
    def test_custom_user_creation_form_when_empty(self):
        ...
        self.assertEqual(form.errors, {})  # Should be an empty dictionary as validation is not carried out.
    ...
    def test_custom_user_creation_form_when_partially_empty(self):
        ...
        self.assertEqual(
            form.errors["position"], ["This field is required."]
        )
        self.assertEqual(
            form.errors["password1"], ["This field is required."]
        )
        self.assertEqual(
            form.errors["password2"], ["This field is required."]
        )
        self.assertFalse(form.is_valid())
